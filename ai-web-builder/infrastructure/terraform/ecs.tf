    ...
    Statement = [
      {
        ...
        Resource = [
          ...
          aws_secretsmanager_secret.ghl_api_key.arn,
          aws_secretsmanager_secret.simvoly_api_key.arn
        ]
      }
    ]
  })
  ...
  container_definitions = jsonencode([
    {
      ...
      secrets = [
        ...
        },
        {
          ...
          valueFrom = aws_secretsmanager_secret.ghl_api_key.arn
        },
        {
          name      = "SIMVOLY_API_KEY"
          valueFrom = aws_secretsmanager_secret.simvoly_api_key.arn
        }
      ]
